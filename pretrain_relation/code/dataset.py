...
class CPDataset(data.Dataset):
    ...
    def __init__(self, path, args):
        ...
        self.pid2name = json.load(open(os.path.join(path, 'pid2name.json')))
        ...
        # def tokenize(marker, *args):
        #     ids, ph, pt = marker().tokenize(*args)
        #     return ids, ph, pt
        #
        ...
        #     h_p = sentence["h"]["pos"][0]
        #     t_p = sentence["t"]["pos"][0]
        #     res.append(pool.apply_async(tokenize, (EntityMarker, sentence["tokens"], [h_p[0], h_p[-1]+1], [t_p[0], t_p[-1]+1], None, None, h_flag, t_flag)))
        #
    ...
    def __getitem__(self, index):
        ...
        return input, mask, label, h_pos, t_pos, rel, rel_label
